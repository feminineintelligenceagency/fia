...
<div class="flex h-full w-full">
	<div class="flex h-full w-24 flex-col items-center space-y-4 border-r p-4 backdrop-blur-xl">
		<a href={resolve('/app')}>
		...
		{#each links as link (link.href)}
			<Button size="icon-lg" variant="ghost" href={link.href} class="rounded-2xl border shadow-sm ">
